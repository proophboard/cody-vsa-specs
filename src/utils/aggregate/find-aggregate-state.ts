import {type CodyResponse, CodyResponseType, NodeType} from "@proophboard/cody-types";
import {getSingleTarget, getTargetsOfType, isCodyError} from "@proophboard/cody-utils";

import {List} from "immutable";
import {makeNodeRecordFromNode, type NodeRecord} from "../../proophboard/node-record.js";
...
export const findAggregateState = (commandEventOrAggregate: NodeRecord<any>, ctx: VsaContext): Success | Error => {
  let events = List<NodeRecord<any>>();
